...
# CONFIGURATION
# -------------------
SOURCE_DIR = Path("./Data Collection")  # original images folder: category/subcategory/images
    ...
    if category_dir.is_dir():
        ...
        for subcategory_dir in category_dir.iterdir():
            if subcategory_dir.is_dir():
                ...
                # Create category/subcategory folders in train/val/test
                for split in ["train", "val", "test"]:
                    target_dir = DATASET_DIR / split / category_name / subcategory_name
                ...
                for split, files in splits.items():
                    for img_path in files:
                        dest_path = DATASET_DIR / split / category_name / subcategory_name / img_path.name
                        shutil.copy2(img_path, dest_path)

print("✅ Dataset folder created with category/subcategory structure for train, val, test.")
